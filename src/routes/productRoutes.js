...
const { validateRequest, validateQuery, productSchema, partialProductSchema, filtersSchema } = require('../middleware/validation');
...
router.put('/:id', validateRequest(partialProductSchema), productController.updateProduct);
